                    ...
                    <ul class="u-sidebar-nav-menu u-sidebar-nav-menu--top-level">
                        ...
                        <li class="u-sidebar-nav-menu__item u-sidebar-nav--opened">
                            ...
                            <ul id="homework" class="u-sidebar-nav-menu u-sidebar-nav-menu--second-level" style="display: none;">
                                ...
                                <li class="u-sidebar-nav-menu__item">
                                    <a class="u-sidebar-nav-menu__link active" href="homework-add-new.html">
                ...
                <section class="es-form-area">
                    <div class="card">
                        <header class="card-header bg-gradient border-0 pt-5 pb-5 d-flex align-items-center">
                            <h2 class="text-white mb-0">Add New Homework</h2>
                        </header>
                        <div class="card-body">
                            <form action="" class="es-form es-add-form">
                                <div class="row">
                                    <div class="col-lg-8 offset-lg-2 col-md-12 mb-4">
                                        ...
                                        </select><div class="nice-select es-add-select" tabindex="0"><span class="current">Select</span><ul class="list"><li data-value="Select" data-display="Select" class="option selected">Select</li><li data-value="1" class="option">Physics</li><li data-value="2" class="option">Chemistry</li><li data-value="2" class="option">Mathematics</li></ul></div>
                                    </div>
                                    ...
                                    <div class="col-lg-8 offset-lg-2 col-md-12 mb-4">
                                        ...
                                        </select><div class="nice-select es-add-select" tabindex="0"><span class="current">Select</span><ul class="list"><li data-value="Select" data-display="Select" class="option selected">Select</li><li data-value="1" class="option">Monday</li><li data-value="2" class="option">Tuesday</li><li data-value="3" class="option">Wednesday</li><li data-value="4" class="option">Thursday</li><li data-value="5" class="option">Friday</li></ul></div>
                                    </div>

                                    <div class="col-lg-8 offset-lg-2 col-md-12 mb-4">
                                        <label for="time">Time</label>
                                        <select id="time" class="es-add-select" style="display: none;">
                                            <option data-display="Select">Select</option>
                                        ...
                                        </select><div class="nice-select es-add-select" tabindex="0"><span class="current">Select</span><ul class="list"><li data-value="Select" data-display="Select" class="option selected">Select</li><li data-value="1" class="option">7:00 - 8:00</li><li data-value="2" class="option">8:00 - 9:00</li><li data-value="3" class="option">9:00 - 10:00</li><li data-value="4" class="option">10:00 - 11:00</li></ul></div>
                                    </div>

                                    <div class="col-lg-8 offset-lg-2 col-md-12 mb-4">
                                        <label for="class">Class</label>
                                        <select id="class" class="es-add-select" style="display: none;">
                                            <option data-display="Select">Select</option>
                                        ...
                                        </select><div class="nice-select es-add-select" tabindex="0"><span class="current">Select</span><ul class="list"><li data-value="Select" data-display="Select" class="option selected">Select</li><li data-value="1" class="option">Vi</li><li data-value="2" class="option">Vii</li><li data-value="3" class="option">Viii</li><li data-value="4" class="option">iX</li><li data-value="5" class="option">X</li></ul></div>
                                    </div>

                                    <div class="col-lg-8 offset-lg-2 col-md-12 mb-4">
                                        <label for="section">Section</label>
                                        <select id="section" class="es-add-select" style="display: none;">
                                            <option data-display="Select">Select</option>
                                            <option value="1">A</option>
                                            <option value="2">B</option>
                                            <option value="3">C</option>
                                        </select><div class="nice-select es-add-select" tabindex="0"><span class="current">Select</span><ul class="list"><li data-value="Select" data-display="Select" class="option selected">Select</li><li data-value="1" class="option">A</li><li data-value="2" class="option">B</li><li data-value="3" class="option">C</li></ul></div>
                                    </div>
