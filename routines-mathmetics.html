                    ...
                    <ul class="u-sidebar-nav-menu u-sidebar-nav-menu--top-level">
                        ...
                        <li class="u-sidebar-nav-menu__item u-sidebar-nav--opened">
                            ...
                            <ul id="subMenu1" class="u-sidebar-nav-menu u-sidebar-nav-menu--second-level" style="display: none;">
                                <li class="u-sidebar-nav-menu__item">
                                    <a class="u-sidebar-nav-menu__link active" href="routines-mathmetics.html">
                ...
                <section class="es-form-area">
                    <div class="card">
                        <header class="card-header bg-gradient border-0 pt-5 pb-5 d-flex align-items-center">
                            <a href="" class="btn btn-sm btn-pill btn-light">Mathematics</a>
                            <a href="" class="btn btn-sm btn-pill btn-outline-light ml-3">Accounting</a>
                                ...
                                <div class="table-responsive table-routines">
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>Monday</td>
                                                <td class="text-center">7:00-8:00 AM <span class="d-block mt-1">X-A</span></td>
                                                <td class="text-center">7:00-8:00 AM <span class="d-block mt-1">X-A</span></td>
                                                <td class="text-center">7:00-8:00 AM <span class="d-block mt-1">X-A</span></td>
                                            </tr>
